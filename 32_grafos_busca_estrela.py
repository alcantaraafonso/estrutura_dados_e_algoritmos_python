    ...
    if self.ultima_posicao == -1:
      ...
      for i in range(self.ultima_posicao + 1):
        print(i, ' - ', self.valores[i].vertice.rotulo, ' - ' \
            , self.valores[i].distancia_estrada, ' - ' \
            , self.valores[i].vertice.distancia_linha_reta_objetivo, ' - ' \
            , self.valores[i].distancia_aestrela)

class Vertice:
    def __init__(self, rotulo, distancia_linha_reta_objetivo):
        self.rotulo = rotulo
        self.distancia_linha_reta_objetivo = distancia_linha_reta_objetivo
...
class Adjacente:
    def __init__(self, vertice, distancia_estrada):
        self.vertice = vertice
        self.distancia_estrada = distancia_estrada
        self.distancia_aestrela = vertice.distancia_linha_reta_objetivo + distancia_estrada
...
class BuscaAEstrela:
  def __init__(self, vertice_objetivo):
    self.objetivo = vertice_objetivo
...
grafo = Grafo()
busca_gulosa = BuscaAEstrela(grafo.bucharest) #destino
